import pygame
from framework.framework import animate
...
class Player(Entity):
    def __init__(self, x, y, movement_speed):
        super().__init__(x, y)
        self.player_rect = pygame.Rect(self.x,self.y, 16, 16)
    ...
    def move(self, tile_rects, scroll, dt):
    ...
    def main(self, display, dt, tile_rects, scroll):
        ...
        self.get_input(dt)
        self.rect, collisions = self.move(tile_rects, scroll, dt)
